...
#### _ExhibitionsTextValid_
From column: _Exhibitions_
>``` python
if getValue("Exhibitions") == 'NULL':
    return ''
else:
    return getValue("Exhibitions")
```
...
| _ExhibitionsTextValid_ | `crm:P3_has_note` | `crm:E22_Man-Made_Object1`|
